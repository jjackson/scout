...
PATCH_TENANT_SCHEMA = "apps.workspace.models.TenantSchema"
PATCH_MATERIALIZATION_RUN = "apps.workspace.models.MaterializationRun"
...
PATCH_SCHEMA_MANAGER = "apps.workspace.services.schema_manager.SchemaManager"
